...
def test_data_generator(target):
    ...
    for test_case in test_cases:
        ...
        # check 3 - b1 elements close to expectation
        try:
        ...
        # check 4 - b2 elements close to expectation
        try:
...
def test_Siamese(target):
    ...
    for test_case in test_cases:
        ...
        # check 1 - model layer and sublayers
        try:
        ...
        # check 2 - trax.layers.combinators.Parallel
        ...
        # check 4 - sublayers type in the 1st parallel set
        try:
        ...
        # check 5 - sublayers type in the 2nd parallel set
        try:
...
def test_TripletLossFn(target):
    ...
    test_cases = [
        ...
        # test case 2
        {
            ...
            "input": {
                "v1": np.array(
                    [[0.1, 0.2, 0.3, 0.4], [0.9, 0.10, 0.11, 0.2], [0.5, 0.6, 0.7, 0.8]]
                ),
                "v2": np.array(
                    [
                        [0.1, 0.2, 0.3, 0.4],
        ...
        # {
        #     "name": "check_random_arr_margin",
        #     "input": {
        #         "v1": np.random.random((256, 256)),
        #         "v2": np.random.random((256, 256)),
        #         "margin": 0.6,
        #     },
        #     "expected": 9.468739,
        # },
    ...
    for test_case in test_cases:
        # if test_case["name"] == "check_random_arr_margin":
        #     np.random.seed(33)
        ...
        # check 2 - Triplet Loss value close to expectation
        try:
...
def test_train_model(target, model, loss, data_generator):
    # Siamese, TripletLoss, train_generator=train_generator, val_generator=val_generator, output_dir='model/'
    successful_cases = 0
    failed_cases = []
    ...
    # check 6 - Test correct output_dir
    try:
...
def test_classify(target, vocab, data_generator):
    ...
    """
    import pickle 
    with open('./support_files/classify_fn/Q1_test.pkl', 'wb') as f:
        #np.save(f, Q1_test)
        pickle.dump(Q1_test, f)

    with open('./support_files/classify_fn/Q2_test.pkl', 'wb') as f:
        pickle.dump(Q2_test, f)
        
    with open('./support_files/classify_fn/y_test.pkl', 'wb') as f:
...
def test_predict(target, vocab, data_generator):
    ...
    for test_case in test_cases:
        ...
        # only check - 2 questions similar OR NOT
        try:
