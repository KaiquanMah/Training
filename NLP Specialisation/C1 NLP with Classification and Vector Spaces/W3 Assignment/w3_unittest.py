...
def test_cosine_similarity(target):
    ...
    test_cases = [
        # test case 1 - king, queen
        {
            "name": "cosine_score_1",
            "input": {"A": word_embeddings["king"], 
                      "B": word_embeddings["queen"]},
            "expected": [0.650, 0.6512, 0.6510957],
        },
        # test case 2 - country, capital
        {
            "name": "cosine_score_2",
            "input": {"A": word_embeddings["Japan"], 
                      "B": word_embeddings["Tokyo"]},
            "expected": [0.699, 0.701, 0.70022535],
        },
        # test case 3 - country, DIFFERENT capital
        {
            "name": "cosine_score_3",
            "input": {"A": word_embeddings["Germany"], 
                      "B": word_embeddings["Beirut"]},
            "expected": [0.172, 0.174, 0.17339969],
        },
        # test case 4 - country, DIFFERENT capital
        # lower bound is much further away compared to the earlier 3 test cases
        {
            "name": "cosine_score_4_to_catch_alternate_solution",
            "input": {"A": word_embeddings["China"], 
                      "B": word_embeddings["Chile"]},
    ...
    for test_case in test_cases:
        ...
        # check whether results are close to expected values
        # 1st - compare based on 1 cosine similarity value
        # 2nd - compare based on lower and upper bound
        try:
...
def test_euclidean(target):
    ...
    test_cases = [
        # similar 4 test cases as cosine similarity
        {
    ...
    for test_case in test_cases:
        ...
        # 1 - check whether euclidean distance is close to expected
        # 2 - otherwise check that euclidean distance is within lower and upper bounds
        try:
            assert np.isclose(
...
def test_get_country(target):
    ...
    for test_case in test_cases:
        ...
        # check whether result is a tuple
        try:
        ...
        # check whether 'word' is as expected
        try:
        ...
        # check whether cosine similarity score is close to expected
        try:
...
def test_get_accuracy(target, data):
    ...
    for test_case in test_cases:
        ...
        # check accuracy score close to expected
        try:
...
def test_compute_pca(target):
    ...
    test_cases = [
        # test case 1 - X is 3x10, 2 PCA components
        {
            "name": "default_check",
            "input": {
        ...
        # test case 2 - X is 5x15, 3 PCA components
        {
            "name": "larger_check",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check results row + col dimensions match expectations
        try:
        ...
        # check resulting elements match expectations
        try:
