...
def test_get_matrices(target):
    ...
    test_cases = [
        # test case 1 training set + english and french word embeddings
        {
            "name": "default_check",
            "input": {
                "en_fr": en_fr_train,
        ...
        # test case 2 test set + english and french word embeddings
        {
            "name": "test_check",
            "input": {
                "en_fr": en_fr_test,
    ...
    for test_case in test_cases:
        ...
        # check 1 - resulting X (english words and their embedding) is an array/matrix
        try:
        ...
        # check 2 - resulting Y (english words and their embedding) is an array/matrix
        try:
        ...
        # check 3 - Resulting X's 1st word => 1st 10 embedding cols => check actual is close to expected values
        try:
        ...
        # check 4 - Resulting Y's 1st word => 1st 10 embedding 'cols' => check actual is close to expected values
        try:
        ...
        # check 5 - # words and # embedding 'cols' in resulting X
        try:
        ...
        # check 6 - # words and # embedding 'cols' in resulting Y
        try:
        ...
        # check 7 - Resulting X's last word => 1st 10 embedding cols => check actual is close to expected values
        try:
        ...
        # check 8 - Resulting Y's last word => 1st 10 embedding cols => check actual is close to expected values
        try:
...
def test_compute_loss(target):
    ...
    test_cases = [
        # test case 1 - 10x5 matrix X and Y, 5x5 matrix R
        {
            "name": "default_check",
            "input": {
                "X": np.array(
        ...
        # test case 2 - 1x1 matrix X and Y, 1x1 matrix R
        {
            "name": "small_check",
            "input": {
                "X": np.array([[0.10]]),
        ...
        # test case 3 - 3x2 matrix X and Y, 2x2 matrix R
        {
            "name": "large_check",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check 1 - actual vs expected loss (averaged across ALL embeddings)
        try:
...
def test_compute_gradient(target):
    ...
    test_cases = [
        # test case 1 - 10x5 X and Y, 5x5 R
        {
            "name": "default_check",
            "input": {
                "X": np.array(
    ...
    for test_case in test_cases:
        ...
        # check 1 - # rows and # cols match expectation
        try:
        ...
        # check 2 - matrix/cell elements match expectation
        try:
...
def test_align_embeddings(target):
    ...
    test_cases = [
        # test case 1 - X and Y 10x5, learning_rate 0.0003
        {
            "name": "default_check",
            "input": {
                "X": np.array(
        ...
        # test case 2 - X and Y 10x5, learning_rate 0.8
        {
        ...
        # test case 3 - X and Y 1x1, learning_rate 0.01
        {
            "name": "smallest_check",
            "input": {
                "X": np.array([[0.10]]),
        ...
        # test case 3 - X and Y 3x2, learning_rate 0.005
        {
            "name": "small_check",
            "input": {
                "X": np.array([[0.10, 0.1], [0.2, 0.4], [0.6, -0.2]]),
    ...
    for test_case in test_cases:
        ...
        # check 2 - matrix elements close to expected
        try:
            assert np.allclose(result, test_case["expected"])
            successful_cases += 1
        except:
...
def test_nearest_neighbor(target):
    ...
    test_cases = [
        # test case 1 - vector v 1x3, candidates 5x3, k 3
        {
            "name": "default_check",
            "input": {
                "v": np.array([1, 0, 1]),
        ...
        # test case 2 - vector v 1x5, candidates 7x5, k 4
        {
            "name": "larger_check",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check 1 - resulting array has 'k' number of cols
        try:
        ...
        # check 2 - elements match expectations
        try:
            assert np.allclose(result, test_case["expected"])
            successful_cases += 1
        except:
...
def unittest_test_vocabulary(target):
    ...
    for test_case in test_cases:
        ...
        # check 1 - resulting accuracy is close to expectation
        try:
            assert np.isclose(result, test_case["expected"])
            successful_cases += 1
        except:
...
def test_get_document_embedding(target):
    ...
    test_cases = [
        # test case 1 - Normal, slightly positive tweet
        {
            "name": "default_check",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check 1 - resulting document embedding # rows and # cols are expected
        try:
            assert result.shape == test_case["expected"].shape
            successful_cases += 1
        except:
        ...
        # check 2 - 1st 10 document embedding values are close to expected
        try:
            assert np.allclose(
        ...
        # check 3 - last 10 document embedding values are close to expected
        # and implicitly assume that the values after 1st 10 and before last 10 values are ok if the 1st and last 10 values are close to expected
        try:
            assert np.allclose(
                result, test_case["expected"], atol=1e-05
            )  # np.allclose(result[-10:], test_case["expected"][-10:])
...
def test_get_document_vecs(target):
    ...
    test_cases = [
        # test case 1 - get document embedding for the pos + neg tweets imported
        {
            "name": "default_check",
        ...
        # test case 2 - get document embedding for 3 tweets
        {
            "name": "small_check",
            "input": {
                "all_docs": [
    ...
    for test_case in test_cases:
        ...
        # check 1 - resulting matrix - #rows and # cols match expecations
        try:
        ...
        # check 2 - resulting dictionary - # keys/items match expecations
        try:
        ...
        # check 3 - 1st 10 values in the 1st document are close to expectation
        try:
            assert np.allclose(
                result_doc[0][:10],
        ...
        # check 4 - 1st 10 values in the last document are close to expectation
        try:
            assert np.allclose(
                result_doc[-1][:10],
        ...
        # this seems to be a duplicate of check 4 above
        try:
            assert np.allclose(
                result_doc[-1][:10],
                test_case["expected"]["doc_vec_last_0until10"],
        ...
        # check 5 - 1st 10 values in the 1st dictionary item are close to expectation
        try:
            assert np.allclose(
                result_dict[0][:10],
...
def test_hash_value_of_vector(target):
    ...
    #  default_check - 300 dimensions, 10 planes, 25 universes, 1st plane
    N_DIMS = 300
    N_PLANES = 10
    N_UNIVERSES = 25
    ...
    # small_check - 20 dimensions, 8 planes, 5 universes, 5th plane
    N_DIMS = 20
    N_PLANES = 8
    N_UNIVERSES = 5
    ...
    # small_check2 - 20 dimensions, 8 planes, 5 universes, 1st plane
    N_DIMS = 20
    N_PLANES = 8
    N_UNIVERSES = 5
    ...
    for test_case in test_cases:
        ...
        # check hash value matches expectation
        try:
...
def test_make_hash_table(target):
    ...
    for test_case in test_cases:
        # hash (hash bucket + vectors) table, id(index of the vectors) table
        result_hash, result_id = target(**test_case["input"])

        # check 1 - # of hash buckets (each with a unique hash #)
        try:
        ...
        # check 3 - (based on the 'hash key' to evaluate specified in the test case, i.e. 'id_to_eval') 
        # retrieve the coresponding 'index/ID values'
        # match against the expected 'id_table' 'index/ID values'
        actual index/IDs in MATCH index/IDs in the expected 'id table'
        try:
            assert (
        ...
        # check 4 - (based on the 'hash key' to evaluate specified in the test case, i.e. 'id_to_eval') 
        # these are hash values specifying the bucket to look for to
        # retrieve the underlying 'vectors' in that bucket from the result_hash table
        # match against the expected 'hash_table' 'vectors'
        try:
            assert np.allclose(
