...
def test_count_tweets(target):
    ...
    test_cases = [
        # test case 1 - 5 tweets - 1 pos 4 neg
        {
            "name": "default_check",
            "input": {
                "result": {},
        ...
        # test case 2 - 8 tweets - 3 pos 5 neg
        {
            "name": "larger_check",
            "input": {
                "result": {},
        ...
        # test case 3 - start with an existing dict with count of words
        # with the same 8 tweets from test case 2
        {
    ...
    for test_case in test_cases:
        ...
        # check if the results returned from executing the 'count_tweets' function
        # is a dictionary
        try:
...
def test_train_naive_bayes(target, freqs, train_x, train_y):
    ...
    test_cases = [
        # test case 1 - whole train_x, train_y dataset
        {
            "name": "default_check",
            "input": {"freqs": freqs, "train_x": train_x, "train_y": train_y},
            "expected": {
        ...
        # test case 2 - 1st 10 + last 10 tweets in train_x; labels in train_y
        {
            "name": "smaller_check",
            "input": {
                "freqs": freqs,
        ...
        # test case 3 - 1st 10 (pos) + last 5 (neg) tweets
        {
            "name": "smaller_unbalanced_check",
            "input": {
                "freqs": freqs,
    ...
    for test_case in test_cases:
        ...
        # check logprior value is a float
        try:
            assert isinstance(result1, np.float64) or isinstance(result1, float)
            successful_cases += 1
        except:
        ...
        # check logprior value is expected
        try:
            assert np.isclose(result1, test_case["expected"]["logprior"])
            successful_cases += 1
        except:
        ...
        # count number of loglikelihood values which matched expectations
        count_good = 0
        ...
        # check count of loglikelihood values matching expectations
        try:
...
def test_naive_bayes_predict(target):
    ...
    test_cases = [
        # test case 1 - logprior 0; slightly pos tweet
        {
            "name": "default_check",
            "input": {
                "tweet": "She smiled.",
        ...
        # test case 2 - logprior 0; neutral/neg tweet
        {
        ...
        # test case 3 - logprior 0; neg tweet
        {
        ...
        # test case 4 - logprior pos; pos tweet => more likely
        {
        ...
        # test case 5 - logprior pos; neutral/neg tweet => more likely
        {
        ...
        # test case 6 - logprior pos; neg tweet => less likely
        {
...
def unittest_test_naive_bayes(target, test_x, test_y):
    ...
    test_cases = [
        # test case 1 - logprior 0, full test set
        {
            "name": "default_check",
            "input": {
                "test_x": test_x,
        ...
        # test case 2 - logprior 0; test 1st 100 pos + last 100 neg tweets
        {
            "name": "smaller_check",
            "input": {
        ...
        # test case 3 - logprior pos; test 1st 100 pos + last 100 neg tweets
        {
        ...
        # test case 4 - logprior 0; test 1st 150 pos + last 100 neg tweets
        {
            "name": "small_check",
            "input": {
        ...
        # test case 4 - logprior pos; test 1st 150 pos + last 100 neg tweets
        {
    ...
    for test_case in test_cases:
        ...
        # test if results are close to expectation
        try:
            assert np.isclose(result, test_case["expected"])
            successful_cases += 1
        except:
...
def test_get_ratio(target, freqs):
    ...
    for test_case in test_cases:
        ...
        # check result is in the form of a dictionary
        try:
            assert isinstance(result, dict)
            successful_cases += 1
        except:
...
def test_get_words_by_threshold(target, freqs):
    ...
    test_cases = [
        # check 1 - NEG tweets BELOW THE THRESHOLD
        {
            "name": "default_check1",
        ...
        # check 2 - POS tweets ABOVE THE THRESHOLD
        {
            "name": "default_check2",
        ...
        # check 3 - NEG tweets BELOW A SMALLER THRESHOLD; i.e. we want to know the highly negative 'words'
        {
        ...
        # check 4 - POS tweets ABOVE A HIGHER THRESHOLD; i.e. we want to know the highly positive 'words'
        {
    ...
    for test_case in test_cases:
        ...
        # check results are in a dictionary
        try:
            assert isinstance(result, dict)
            successful_cases += 1
        except:
        ...
        # check whether each resulting dictionary has the # of sub-dictionaries
        ...
        # check whether each resulting dictionary in the larger results dictionary
