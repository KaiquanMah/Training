...
def test_split_to_sentences(target):
    ...
    test_cases = [
        ...
        # test case 3 - blank spaces per 'sentence'
        {"name": "space_null_check", "input": """ \n \n\n\n""", "expected": [],},
        # test case 4 - characters per 'sentence'
        {
            "name": "small_check",
            "input": """a\n  b\n\n\n. """,
            "expected": ["a", "b", "."],
    ...
    for test_case in test_cases:
        ...
        # check 2 - 'tokenised sentences' match expectation
        try:
        ...
        # check 3 - blank list for 'NULL check'
        ...
        # check 4 - character length == 1 for the 'SMALL CHECK'
...
def test_tokenize_sentences(target):
    ...
    test_cases = [
        ...
        # test case 5 - 1 element containing ONLY SPACES
        {
    ...
    for test_case in test_cases:
        ...
        # check 2 - # of sentences match expectation
        try:
        ...
        # check 3 - tokenised sentences match expectation
        try:
...
def test_get_tokenized_data(target):
    ...
    test_cases = [
        # test case 1 - original sentences
        {
            "name": "default_check",
            "input": "Sky is blue.\nLeaves are green\nRoses are red.",
            "expected": [
        ...
        # test case 2 - sentences with EXTRA WHITESPACE
        {
            "name": "spaces_check",
            "input": "   Sky   is  blue.   \nLeaves are green.\nSpace  if  Infinite.\nOR IS IT?\n\n   \nLast sentence .\n",
            "expected": [
...
def test_count_words(target):
    ...
    for test_case in test_cases:
        ...
        # check 2 - word count dict match expectations
        try:
            assert result == test_case["expected"]
            successful_cases += 1
        except:
...
def test_get_words_with_nplus_frequency(target):
    ...
    test_cases = [
        ...
        # test case 3 - count_threshold increase from 2 to 4
        {
    ...
    for test_case in test_cases:
        ...
        # check 2 - # vocab words match expectation
        try:
            assert len(result) == len(test_case["expected"])
            successful_cases += 1
        except:
        ...
        # check 3 - vocab words match expectation
        try:
            assert result == test_case["expected"]
            successful_cases += 1
        except:
...
def test_replace_oov_words_by_unk(target):
    ...
    test_cases = [
        ...
        # test case 2 - 4 sentences with new +- unknown words
        {
            "name": "unk_check",
            "input": {
                "tokenized_sentences": [
    ...
    for test_case in test_cases:
        ...
        # so for each sentence sub-list
        for elem in result:  # test_case["expected"]["expected_list"]:
            # if <unknown token> is found in the sentence sub-list
            if test_case["input"]["unknown_token"] in elem:
                # count the # of occurences in that sentence sub-list
                # increment until we finish ALL sentences from our result
                count_unk_result += elem.count(test_case["input"]["unknown_token"])

        # test_case["input"]["unknown_token"] => "<unk>" or "-1"
        
        # match our result's vs unit test's unknown element count
        try:
        ...
        # check 3 - check tokenised sentences +- unknown token
        try:
...
def test_preprocess_data(target):
    ...
    for test_case in test_cases:
        ...
        # check 1 - from 'result' => each of the resulting outputs is a list
        try:
            for elem in result:
        ...
        # result[0] => replaced tokenised words in the training set 
        # IN EACH SENTENCE SUBLIST =>
        # check COUNT OF UNKNOWN TOKENS MATCH EXPECTATION
        count_unk_result = 0
        ...
        # CHECK 3 - REPEATS CHECK 2 ON TEST SET
...
def test_count_n_grams(target):
    ...
    test_cases = [
        ...
        # test case 3 - n=3 trigram, start_token '-1', end_token '-2'
        {
            "name": "large_check",
            "input": {
                "data": [
    ...
    for test_case in test_cases:
        ...
        # check 2 - result dict's n-gram tuple keys + count values match expectation
        try:
            assert result == test_case["expected"]
            successful_cases += 1
        except:
...
def test_estimate_probability(target):
    ...
    for test_case in test_cases:
        ...
        # only check - bayesian/conditional probability of the current word based on previous n-words
        try:
...
def test_calculate_perplexity(target):
    ...
    test_cases = [
        ...
        # test case 3 - sky sentence; start token '-1', end token '-2'
        {
        ...
        # test case 4 - cat sentence again
        {
    ...
    for test_case in test_cases:
        ...
        # only check - perplexity score match expectation
        try:
            assert np.isclose(result, test_case["expected"])
            successful_cases += 1
        except:
...
def test_suggest_a_word(target):
    ...
    test_cases = [
        ...
        # test case 3 - different previous tokens; start_with 'None'
        {
            "name": "default_check_2",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check 1 - result[0] => word suggestion => is a string
        try:
        ...
        # check 2 - result[1] => max_prob => is a float or int
        try:
        ...
        # check 3 - result[0] => word suggestion => matches expectation
        try:
        ...
        # check 4 - result[1] => max_prob => matches expectation
        try:
