...
def test_create_dictionaries(target, training_corpus, vocab):
    ...
    test_cases = [
        # test case 1 - full training_corpus
        {
            "name": "default_case",
            "input": {
        ...
        # test case 2 - 1st 1k word-tag combos from the training_corpus
        {
            "name": "small_case",
            "input": {
    ...
    for test_case in test_cases:
        ...
        # check 1 - emissions are in a dictionary
        try:
        ...
        # check 2 - count of emission keys match expectation
        try:
        ...
        # check 3 - each emission count is close to expected
        try:
        ...
        # check 4 - transitions are in a dictionary
        try:
        ...
        # check 5 - count of transition keys is expected
        try:
            assert (
        ...
        # check 6 - each transition count is close to expected
        try:
        ...
        # check 7 - tags count is in a dict
        try:
        ...
        # check 8 - count of result tag keys match expectation
        try:
        ...
        # check 9 - each result tag count is close to expected
        try:
...
def test_predict_pos(target, prep, y, emission_counts, vocab, states):
    ...
    test_cases = [
        # test case 1 - full 'preprocessed' list of test words
        {
            "name": "default_check",
            "input": {
                "prep": prep,
        ...
        # test case 2 - 1st 1k 'preprocessed' list of test words
        {
            "name": "small_check",
            "input": {
                "prep": prep[:1000],
    ...
    for test_case in test_cases:
        ...
        # check - accuracy score is close to expectation
        try:
...
def test_create_transition_matrix(target, tag_counts, transition_counts):
    ...
    for test_case in test_cases:
        ...
        # check 1 - results are in an array
        try:
        ...
        # check 2 - transition probabilities from prev tag to current tag match expectation around the start of the matrix
        try:
        ...
        # check 3 - transition probabilities from prev tag to current tag match expectation around the middle of the matrix
        try:
...
def test_create_emission_matrix(target, tag_counts, emission_counts, vocab):
    ...
    for test_case in test_cases:
        ...
        # check 2 - emission probabilities match expectations
        try:
            assert np.allclose(result[0:5, 0:5], test_case["expected"]["0:5"])
            successful_cases += 1
        except:
        ...
        # check 3 - emission probabilities match expectations
        try:
            assert np.allclose(result[30:35, 30:35], test_case["expected"]["30:35"])
            successful_cases += 1
        except:
...
def test_initialize(target, states, tag_counts, A, B, corpus, vocab):
    ...
    for test_case in test_cases:
        ...
        # check 1 - best_probs is in an array
        try:
        ...
        # check 2 - best_paths is in an array
        try:
        ...
        # check 3 - best_probs shape/dimensions match expectation
        try:
        ...
        # check 4 - best_paths shape/dimensions match expectation
        try:
        ...
        # check 5 - best_probs 1st col elements match expectation
        try:
            assert np.allclose(
        ...
        # check 6 - best_paths 1st col elements match expectation
        try:
...
def test_viterbi_forward(target, A, B, test_corpus, vocab):
    ...
    for test_case in test_cases:
        ...
        # check 1 - best_probs is an array
        try:
            assert isinstance(result_best_probs, np.ndarray)
            successful_cases += 1
        except:
        ...
        # check 2 - best_paths is an array
        try:
            assert isinstance(result_best_paths, np.ndarray)
            successful_cases += 1
        except:
        ...
        # check 3 - best_probs elements match expectation
        try:
            assert np.allclose(
        ...
        # check 4 - best_probs elements match expectation
        try:
            assert np.allclose(
        ...
        # check 5 - best_paths elements match expectation
        try:
            assert np.allclose(
        ...
        # check 6 - best_paths elements match expectation
        try:
            assert np.allclose(
...
def test_viterbi_backward(target, corpus, states):
    ...
    for test_case in test_cases:
        ...
        # check 3 - tags at the start of the path
        try:
        ...
        # check 4 - tags at the end of the path
        try:
...
def test_compute_accuracy(target, pred, y):
    ...
    test_cases = [
        # test case 1 - full 'pred' word corpus
        {
            "name": "default_check",
            "input": {"pred": pred, "y": y},
            "expected": 0.953063647155511,
        },
        # test case 2 - 1st 100 words in the 'pred' corpus
        {
            "name": "small_check",
    ...
    for test_case in test_cases:
        ...
        # check 1 - accuracy score is a float
        try:
        ...
        # check 2 - accuracy score is close to expectation
        try:
            assert np.isclose(result, test_case["expected"])
            successful_cases += 1
        except:
